...
void Dedede::Start()
{
	...
	Renderer_->CreateAnimation("KingDedede.bmp", "JumpRight",8,10,0.1f,true);
	Renderer_->CreateAnimation("KingDedede.bmp", "JumpLeft",40,52,0.1f,true);
	Renderer_->CreateAnimation("KingDedede.bmp", "AttackRight",11,20,0.1f,true);
	Renderer_->CreateAnimation("KingDedede.bmp", "AttackLeft",43,62,0.1f,true);
